...
import { Plugin as z, PluginKey as B } from "@milkdown/prose/state";
import { ySyncPlugin as V, yUndoPlugin as _, redo as O, undo as H, yCursorPlugin as I, yXmlFragmentToProseMirrorRootNode as W, prosemirrorToYDoc as q, ySyncPluginKey as G, yCursorPluginKey as J, yUndoPluginKey as Q } from "y-prosemirror";
import { encodeStateAsUpdate as Z, applyUpdate as $ } from "yjs";
const k = new B("MILKDOWN_COLLAB_KEYMAP"), tt = [
  k,
  G,
  J,
  Q
