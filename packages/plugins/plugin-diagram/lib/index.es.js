...
import { $remark as k, $ctx as h, $nodeSchema as C, $command as N, $inputRule as x } from "@milkdown/utils";
...
const o = "diagram", d = C(o, (t) => (D.initialize({
  ...t.get(l.key)
}), {
  content: "text*",
  group: "block",
