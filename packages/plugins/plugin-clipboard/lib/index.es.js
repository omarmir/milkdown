import { schemaCtx as D, editorViewOptionsCtx as N, serializerCtx as T, parserCtx as O } from "@milkdown/core";
...
const W = F((r) => {
  ...
  return new A({
    ...
    props: {
      handlePaste: (t, l) => {
        var x, S;
        const d = r.get(O), i = (S = (x = t.props).editable) == null ? void 0 : S.call(x, t.state), { clipboardData: a } = l;
