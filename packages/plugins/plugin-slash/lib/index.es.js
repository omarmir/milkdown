...
class X {
  constructor(e) {
    ...
    a(this, c, !1), this.onShow = () => {
      ...
      const { selection: r } = t.state, { empty: m, $from: l } = r, $ = t.state.selection instanceof _, k = this.element.contains(document.activeElement), w = !t.hasFocus() && !k, P = !t.editable, O = !U(n)(t.state.selection);
      if (!(w || P || !m || !$ || O))
